...
<head>
    ...
    <style>
        ...
        .table-container {
            width: 80%;
            height: 400px; /* Set height for scroll */
...
<body>
    ...
    <form class="search-form" method="POST" action="">
        <input type="text" name="search" placeholder="Search by Name, Email, or ID" value="<?php echo isset($_POST['search']) ? $_POST['search'] : ''; ?>">
        <button type="submit">Search</button>
    </form>

    <!-- Scrollable Voter Table -->
