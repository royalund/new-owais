...
<body>
	...
	<ul class="nav justify-content-center bg-dark" style="padding:20px;">
        <li class="nav-item">
            <h1 style="font-family: bangers;color: blanchedalmond;">Bhart Voting System</h1>
        </li>
    </ul>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="votes-column">Votes</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="votes-column">Total Votes: <?php echo $row['votes']; ?></td>
                        </tr>
                        <?php	
                        }
                        ?>
